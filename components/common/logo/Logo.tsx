    ...
    <div className={`flex flex-col ${className}`}>
      ...
      <div className="flex items-center gap-2.5">
        ...
        >
          ...
          <rect x="29" y="2" width="8" height="14" rx="2" fill="#1c75bc" />
        </svg>

        {/* Wordmark */}
        <div className="leading-none">
          <span className="text-[22px] font-light tracking-tight text-slate-400">
            LarnGear
          </span>
      ...
      <div className="mt-1.5 h-[2px] w-full bg-linear-to-r from-brand to-brand-bright" />
